...
<html>
  ...
  <body>
    ...
    <div class="pageWrapper">
      <a id="ecommerce-car-dealership-link" href="http://mhernandez.road2hire.ninja/MickeysImports/" target="_blank">
      <div class="week" id="ecommerce-car-dealership-wrapper">
        <h2>E-Commerce Dealership</h2>
      ...
      <a id="number-guessing-game-link" href="http://mhernandez.road2hire.ninja/numbergame/" target="_blank">
      <div class="week" id="number-guessing-game-wrapper">
      ...
      <a id="facebook-comment-app-link" href="http://mhernandez.road2hire.ninja/reactfacebook/" target="_blank">
      <div class="week" id="facebook-comment-app-wrapper">
        <h2>Facebook Comment App</h2>
      ...
      <a id="blackjack-card-game-link" href="http://mhernandez.road2hire.ninja/Insane/insane.php" target="_blank">
      <div class="week" id="blackjack-card-game-wrapper">
      ...
      <a id="mysql-db-calls-link" href="http://mhernandez.road2hire.ninja/PHPFormChallenges/Challenge1/" target="_blank">
      <div class="week" id="mysql-db-calls-wrapper">
        <h2>mySQL DB Calls</h2>
